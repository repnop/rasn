...
## [0.22.1](https://github.com/repnop/rasn/compare/rasn-v0.22.0...rasn-v0.22.1) - 2025-01-03
...
- Fix panic in the JER OctetString decoder if the string isn't even length ([#382](https://github.com/repnop/rasn/pull/382))
...
- Remove trails of BitSlice and unnecessary length checks ([#381](https://github.com/repnop/rasn/pull/381))
